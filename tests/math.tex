...
%\GFSNeohellenicFonts 
%\KpFonts % ugly
%\LatinModernFonts  % ugly
%\LegibleFonts
%\LibertinusFonts
%\NewComputerModernFonts % ugly
%\STIXTwoFonts
%\BonumFonts % most pages, ugly
%\PagellaFonts
%\ScholaFonts %ugly
%\TermesFonts
\XITSFonts
...
{1lIiLij aα vν} \; \textbf{{1lIiLij aα vν}}\\
{\textit{1lIiLij aα vν}} \; \textbf{{\textit{1lIiLij aα vν}}}\\
\textsf{1lIiLij aα vν} \; \textbf{\textsf{1lIiLij aα vν}}\\
\textsf{\textit{1lIiLij aα vν}} \; \textbf{\textsf{\textit{1lIiLij aα vν}}}\\
$\mathsf{1lI
iLij a\alpha v\nu} \; \mathbfsf{1lIiLij a\alpha v\nu}$\\
$\mathsfit{1lIiLij a\alpha v\nu} \; \mathbfsfit{1lIiLij a\alpha v\nu}$
