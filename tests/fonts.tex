...
\NewDocumentCommand{\ShowFontA}{m m m}{%
...
shape: #2\\
\ShowFontA{#1}{ul}{#2}\ShowFontA{#1}{el}{#2}\ShowFontA{#1}{l}{#2}
\ShowFontA{#1}{sl}{#2}\ShowFontA{#1}{m}{#2}\ShowFontA{#1}{sb}{#2}
\ShowFontA{#1}{b}{#2}\ShowFontA{#1}{eb}{#2}\ShowFontA{#1}{ub}{#2}
\newpage
}
