...
\newglossaryentry{PositiveIntegers}{
  ...
  \SetSpec{i\glssymbol{elementOf}\glssymbol{Integers}}{i>0}}},
  parent=Integers}

\newglossaryentry{NaturalNumbers}{
  name={natural numbers},
  text={natural numbers},
  symbol={\ensuremath{\Space{N}}},
  description={\ensuremath{
  \SetSpec{i\glssymbol{elementOf}\glssymbol{Integers}}{i \geq 0}}}}

\newglossaryentry{RationalNumbers}{
  name={rational numbers},
  text={rational numbers},
  symbol={\ensuremath{\Space{Q}}},
  description={
  \ensuremath{
  \SetSpec{i/j}{
